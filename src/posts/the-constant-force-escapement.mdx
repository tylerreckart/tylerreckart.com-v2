...
<div className="image-full">
  <img src="https://s3.us-east-2.amazonaws.com/t-reckart/Derek-Pratt-Ron-DeCorte.jpg" />
  <em className="image-source">The Derek Pratt watch developed by Ron DeCorte and Stewart Lesemann</em>
</div>
...
<div className="image-wrap left">
  <img src="https://s3.us-east-2.amazonaws.com/t-reckart/john_harrison_uhrmacher.jpg" />
  <em className="image-source">John Harrison</em>
</div>
...
_Although, it can be argued that the most perfect train remontoires ever constructed were those created by John Harrison for his second timepiece H2 and all of his subsequent clocks with his work with culminating in the use of a 7 and 1/2 second train remontoire used in his masterpiece H4._
_Although, it can be argued that the most perfect train remontoires ever constructed were those created by John Harrison for his second timepiece H2 and all of his subsequent clocks with his work with culminating in the use of a 7 and 1/2 second train remontoire used in his masterpiece H4._
...
<div className="image-full">
  <img src="https://s3.us-east-2.amazonaws.com/t-reckart/George-Daniels-pocket-watch.jpg" />
  <em className="image-source">A pocket watch developed by George Daniels featuring a tourbillon.</em>
</div>

Let me be clear, integrating a remontoire into a tourbillon watch is a significant design challenge. Breguet only ever produced two watches with the engraving "[Echappement à force-constante](https://www.breguet.com/fr/histoire/chronologie/faits-marquants/%C3%A9chappement-%C3%A0-force-constante)", though only one survives and it has had its original escapement removed. It wasn't until 1981 when Derek Pratt set out to design a completely new remontoire tourbillon that this concept would be fully realized. Derek's revolutionary idea was to mount the train-driven remontoire within the tourbillon cage itself.
